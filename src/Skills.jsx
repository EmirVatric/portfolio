    ...
    if (props.index.destination !== undefined) {
      ...
      if (props.index.destination.index === 2) {
        ...
        for (let i = 0; i < tech.length; i++) {
          ...
          counter += 0.2;
          TweenMax.to(tech[name], 0.5, {
            opacity: 1,
            y: 0,
            delay: counter,
            ease: Power3.easeOut
          });
          TweenMax.to(tech2[name2], 0.5, {
            opacity: 1,
            y: 0,
            delay: counter,
            ease: Power3.easeOut
    ...
    <div ref={el => (wrapper = el)} className="skillsWrapper">
      <div className="side border">
        ...
        <div className="languages">
          <div className="language" ref={el => (tech.react = el)}>
            <div className="logoWrapper">
              <img src={reactSvg} alt="react-Logo" />
            </div>
            <span>ReactJS</span>
          </div>
          <div ref={el => (tech.angular = el)} className="language">
            <div className="logoWrapper">
              <img src={angularPng} alt="angular-Logo" />
            </div>
            <span>Angular 2+</span>
          </div>
          <div ref={el => (tech.html = el)} className="language">
            <div className="logoWrapper">
              <img src={htmlPng} alt="html-Logo" />
            </div>
            <span>HTML</span>
          </div>
          <div ref={el => (tech.css = el)} className="language">
            <div className="logoWrapper">
              <img src={cssPng} alt="css-Logo" />
            </div>
            <span>CSS</span>
          </div>
          <div ref={el => (tech.bootstrap = el)} className="language">
            <div className="logoWrapper">
              <img src={bootstrapPng} alt="bootstrap-Logo" />
            </div>
            <span>Bootstrap</span>
          </div>
          <div ref={el => (tech.jquery = el)} className="language">
            <div className="logoWrapper">
      ...
      <div className="side">
        ...
        <div className="languages">
          <div ref={el => (tech2.rails = el)} className="language">
            <div className="logoWrapper">
              <img src={railsPng} alt="rails-Logo" />
            </div>
            <span>Ruby on Rails</span>
          </div>
          <div ref={el => (tech2.node = el)} className="language">
            <div className="logoWrapper">
              <img src={nodePng} alt="node-Logo" />
            </div>
            <span>Node.js</span>
          </div>
          <div ref={el => (tech2.post = el)} className="language">
            <div className="logoWrapper">
              <img src={postgrePNG} alt="postgresql-Logo" />
            </div>
            <span>PostgreSQL</span>
          </div>
          <div ref={el => (tech2.mongo = el)} className="language">
            <div className="logoWrapper">
              <img src={mongoPNG} className="mongo" alt="mongodb-Logo" />
            </div>
            <span>MongoDB</span>
          </div>
          <div ref={el => (tech2.javascript = el)} className="language">
            <div className="logoWrapper">
              <img src={jsPng} alt="javascript-Logo" />
            </div>
            <span>JavaScript</span>
          </div>
          <div ref={el => (tech2.git = el)} className="language">
            <div className="logoWrapper">
